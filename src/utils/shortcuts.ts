...
export const SHORTCUT_ACTIONS: ShortcutActionMeta[] = [
  ...
  { action: 'saveCurrentRequest', label: '保存请求', description: '打开保存弹窗(命名 + 选择落点)', defaultShortcut: 'Mod+S', group: '请求' },
  { action: 'createNewRequest', label: '新建请求', description: '在当前集合/文件夹中新建请求', defaultShortcut: 'Mod+N', group: '请求' },
